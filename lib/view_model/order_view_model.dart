...
class OrderViewModel with ChangeNotifier {
  ...
  void setStops(List<Map<String, dynamic>> stopsList) {
    print("🛑 STOPS SET: $stopsList");   // 👈 yahan lagana hai

    _stops = stopsList;

    print("🛑 STORED STOPS: $_stops");  // 👈 optional but useful
  ...
  Future<void> orderApi(
    ...
    try {
      ...
      if (response["status"] == 200) {
        ...
        driverRideVm.setInitialData(updatedOrderData);
